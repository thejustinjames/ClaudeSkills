#!/usr/bin/env python3
"""Scaffold a decision workspace.

Usage:
    python scripts/init_workspace.py <decision-slug> [--dir PARENT]
...
def main() -> int:
    ...
    parser.add_argument("slug", help="short name for the decision")
    ...
    print("and interviewing for an analysis that will not happen wastes goodwill.")
    return 0
